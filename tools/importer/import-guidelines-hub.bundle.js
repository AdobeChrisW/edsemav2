...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-guidelines-hub.js
  var import_guidelines_hub_exports = {};
  __export(import_guidelines_hub_exports, {
    default: () => import_guidelines_hub_default
  });
  ...
  // tools/importer/parsers/cards-guidelines.js
  function parse2(element, { document: document2 }) {
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "cards-guidelines", cells });
    element.replaceWith(block);
  }
  ...
  var import_guidelines_hub_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_guidelines_hub_exports);
})();
